 ...
 * @version 14.2.2013
 */
public class TwitterOAuthTester extends javax.swing.JFrame {

    private TwitterOAuth.RequestToken requestToken;
    private TwitterOAuth.Authorize authorizer;
    private TwitterOAuth.AccessToken accessToken;

    public TwitterOAuthTester() {
        initComponents();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new TwitterOAuthTester().setVisible(true);
            }
        });
    }
    ...
    private Action getRequestTokenAction() {
        Action action = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                requestToken = new TwitterOAuth.RequestToken();
                try {
                    ...
                    authorizer = new TwitterOAuth.Authorize(requestToken);
                    Desktop.getDesktop().browse(authorizer.getURI());
                } catch (Exception ex) {
                    Logger.getLogger(TwitterOAuthTester.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        };
        ...
        Action action = new AbstractAction() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    accessToken = new TwitterOAuth.AccessToken(pin, requestToken);
